"""Tests for beets.artifacts: data model, registry, markdown."""
...
from beets.artifacts.models import (
    KIND_HTML,
    KIND_MARKDOWN,
    KIND_SCREENSHOT,
    KIND_VIDEO,
)
from beets.artifacts.registry import guess_media_type
from beets.stats import page_stats
