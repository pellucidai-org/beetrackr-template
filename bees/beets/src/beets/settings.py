...
class ScraperConfig(BaseModel):
    ...
    user_agent: str = "Bee Travel eSIM Scraper/0.1 (+https://example.com)"
...
class ApiConfig(BaseModel):
    ...
    enable_ui: bool = True
    ui_page_size: int = 25
    ui_title: str = "Travel eSIM Scraper dashboard"
...
class Settings(BaseSettings):
    ...
    # --- core ---
    app_name: str = "Travel eSIM Scraper"
