...
from beets.api.auth import build_auth_router
from beets.api.database import close_db, init_db
from beets.api.routes import fetch, health, scrape
from beets.api.ui import build_ui_router
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        version=__version__,
        description="Bee Travel eSIM scrapers (Airalo + Vodafone Travel).",
